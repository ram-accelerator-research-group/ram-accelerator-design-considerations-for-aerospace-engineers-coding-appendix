%% inlet_throat_plots_kantrowitz
% This script is designed to plot a 2D view of the Busemann toroid
% demonstrating how the Kantrowitz ratio influences the throat size.
...
r_throat_c = r_throat_calc(r_inlet, area_ratio);
...
area_ratio_test = Kantrowitz5( Mach_num,gamma_test);
